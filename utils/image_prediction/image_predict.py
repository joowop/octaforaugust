...
file_dir = r"../../tmp/predicted"
modelpath = r"../../model_ai.book_dectection/book_detection.pt" ##model path
...
class ImagePredict:
    ...
    def show_predict(self): ## 
        ...
        img_location = '../../tmp/predict_image_{}.jpg'.format(dt.date.now()),
        img.save("".join(img_location),'JPEG')
    ...
    def reversed_book_location(self): ##뒤집힌 책 보여주는 함수
        ...
        img_location = "".join(file_dir,'/reversed_image_{}.jpg'.format(dt.date.now()))
