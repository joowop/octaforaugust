import { CheckCollections, LiveOrganization, OrgarnizeCollections } from '../pages/Librarian/Sidemenu';
...
const ROUTE_PATH_LIST = {
    ...
    "LibrarianMain": {path: '/librarian', component: Librarian, label: 'Librarian Main'},
        ...
        "LibrarianOrganization": {path: '/librarian/organize', component: OrgarnizeCollections, label: 'Organization'},
            "OrganizeAll": {path: 'organize/all', component: All, label: 'OrganizeAll'},
            "OrganizeOne": {path: 'organize/one', component: One, label: 'OrganizeOne'},
            "OrganizeNow": {path: 'organize/now', component: Now, label: 'OrganizeNow'},
